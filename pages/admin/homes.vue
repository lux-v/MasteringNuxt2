<template>
  <div>
    ...
    <form class="form" @submit.prevent="onSubmit">
      ...
      <input type="text" v-model="home.images[5]" class="w-3/4" /><br />
      Title: <br />
      <input type="text" v-model="home.title" class="w-60" /><br />
      Description: <br />
      <input type="text" v-model="home.description" class="w-104" /><br />
      Note: <br />
      <input type="text" v-model="home.note" class="w-104" /><br />
      Features: <br />
      <input type="text" v-model="home.features[0]" class="w-26" /><br />
      <input type="text" v-model="home.features[1]" class="w-26" /><br />
      <input type="text" v-model="home.features[2]" class="w-26" /><br />
      <input type="text" v-model="home.features[3]" class="w-26" /><br />
